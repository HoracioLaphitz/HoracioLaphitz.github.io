...
export const EXPERIENCE_ITEMS: readonly ExperienceItem[] = [
  {
    ...
    role: "Especialista en carga de datos",
    company: "Ucrop.it",
    location: "Remoto",
    ...
    details: [
      ...
      { text: "Uso de machine learning para detectar inconsistencias en los datos; el CV no detalla el modelo utilizado", sources: ["cv-2026-08-27"], scope: "company-shared" },
      { text: "Desarrollo de agentes de IA para automatizar tareas", sources: ["cv-2026-08-27"], scope: "company-shared" },
    ],
  ...
  },
  {
    ...
    location: "Posadas",
    description: "Soporte técnico para PC, servidores y sistemas operativos",
    details: [
  ...
  },
  {
    ...
    role: "Proyecto de base de datos y automatización",
    company: "Ferretería Centenario Posadas",
    location: "Posadas, Misiones",
    description: "Base de datos MySQL, flujos en n8n y pipelines de datos en Python",
    details: [
      { text: "Desarrollo de base de datos MySQL", sources: ["cv-2026-08-27"], scope: "engagement" },
      { text: "Automatización de tareas con n8n", sources: ["cv-2026-08-27"], scope: "engagement" },
  ...
  },
  {
    ...
    role: "Capacitador de soporte técnico",
    ...
    details: [
      ...
      { text: "Seguimiento del personal y elaboración de informes sobre ese trabajo", sources: ["cv-2026-08-27"], scope: "engagement" },
    ],
