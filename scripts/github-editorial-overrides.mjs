export const GITHUB_EDITORIAL_OVERRIDES = Object.freeze({
  "Analisis-Datos-2": {
  ...
  "Capitalizacion-del-Mercado-de-los-Bancos-mas-Grandes": {
  ...
  PortfolioAstro: {
    ...
    description: "Portfolio personal desarrollado con Astro.",
  },
  PrediccionImagenes: {
